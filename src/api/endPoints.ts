...
export const ENDPOINTS = {
  ...
  addRatingDetail:(foodId: string | number) => `/core/foods/${foodId}/reviews/`,
  patchRatingDetail:(foodId: string | number, reviewId: string | number) => `/core/foods/${foodId}/reviews/${reviewId}/`,
  ...
  categoryFood:(categoryId: string | number) => `/core/foods/filter/?category_id=${categoryId}`,

  getProductDeals:"/core/product-deals/",
  
  productDetails:(offerId: string | number) => `/core/product-deals/${offerId}/`,
